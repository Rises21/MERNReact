  ...
  return (
    <>
      <div id="imageHome" className="container-fluid text-center">        
        <figure className="figure mx-auto p-4">
          <img src={profile} className="figure-img img-fluid rounded-circle shadow mx-auto" alt="profile.png" width="200px" />
          <figcaption style={{fontSize: "1.5em",color:"#205295"}} className="figure-caption">Bangkit Setio R</figcaption> 
